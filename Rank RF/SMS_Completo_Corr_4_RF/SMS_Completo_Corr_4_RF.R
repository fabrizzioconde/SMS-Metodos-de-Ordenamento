...
list.snp<-list(1,2,3,c(4,5),c(6,7,8))  #Indica quais s?o os marcadores causais
list.ia<-list(1,2,3,c(-1,2),c(1,2,3))  #Contru??o das intera??es entre os 5 marcadores causais
