...
num_individuos<-250;                 #N?mero de indiv?duos na amostra.
num_snp<-1000;                       #Total de marcadores simulados.
list.snp<-list(1,10,20,30,40,50,60)  #Indica quais s?o os marcadores causais.
...
save.image(file="SMS_corr_6_005.RData")
