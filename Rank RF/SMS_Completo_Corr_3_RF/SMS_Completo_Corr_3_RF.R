...
list.snp<-list(c(1,2,3),c(4,5,6),c(7,8,9))  #Indica quais s?o os marcadores causais
list.ia<-list(c(1,2,3),c(-1,2,3),c(1,-2,3))  #Contru??o das intera??es entre os 5 marcadores causais
