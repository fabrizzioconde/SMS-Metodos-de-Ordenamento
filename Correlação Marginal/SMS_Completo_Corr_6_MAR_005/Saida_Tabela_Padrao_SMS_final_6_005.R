...
snps_causais <- c("SNP1", "SNP10", "SNP20", "SNP30", "SNP40", "SNP50", "SNP60")
...
writeLines(latex_content, "snps_output_6_MAR_005.tex")

# Imprimindo mensagem de confirmação
cat("Arquivo 'snps_output_6_MAR_005.tex' foi gerado com sucesso.\n")
