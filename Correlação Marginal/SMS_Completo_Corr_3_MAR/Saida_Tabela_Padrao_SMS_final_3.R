...
snps_causais <- c("SNP1", "SNP2", "SNP3", "SNP4", "SNP5", "SNP6", "SNP7", "SNP8", "SNP9")
...
writeLines(latex_content, "snps_output_3_MAR.tex")

# Imprimindo mensagem de confirmação
cat("Arquivo 'snps_output_3_MAR.tex' foi gerado com sucesso.\n")
