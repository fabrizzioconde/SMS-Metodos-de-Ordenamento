...
latex_content <- paste0(latex_content, "\\begin{table}[h]\n\\caption{Rank Correlação Parcial para a Simulação 1.}\n\\label{tab 2}\n")
...
writeLines(latex_content, "snps_output_1_PAR.tex")

# Imprimindo mensagem de confirmação
cat("Arquivo 'snps_output_1_PAR.tex' foi gerado com sucesso.\n")
