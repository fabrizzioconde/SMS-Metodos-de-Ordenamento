...
df <- data.frame(
  ...
  `CAR Score` = c(20, 30, 20, 20, 20),
  `MAR Score` = c(20, 30, 20, 20, 20),
  `PAR Score` = c(20, 90, 90, 40, 30),
  `I Score` = c(30, 30, 20, 20, 20)
)

# Adicionar título
title <- "Número de SNPs selecionados pela etapa de Corte para simulação 2."
...
print.xtable(latex_table, file = "numero_de_snps_selecionados_simulacao2.tex", include.rownames = FALSE, sanitize.text.function = function(x){x})
